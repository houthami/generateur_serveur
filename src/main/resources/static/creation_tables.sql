...
CREATE TABLE OPF_NAT_FONCTION
(
  CODNATFO  VARCHAR2(10 BYTE),
  LIBNATFO  VARCHAR2(100 BYTE)
) ;
CREATE UNIQUE INDEX PK_OPF_NAT_FONCTION ON OPF_NAT_FONCTION (CODNATFO) TABLESPACE ORASS_IX;
ALTER TABLE OPF_NAT_FONCTION ADD (
  CONSTRAINT PK_OPF_NAT_FONCTION
  PRIMARY KEY
  (CODNATFO)
  USING INDEX PK_OPF_NAT_FONCTION
  ENABLE VALIDATE);
